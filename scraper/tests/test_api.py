...
class TestScrapingSourceList:
    ...
    def test_list_sources_contains_result_count(self, api_client, sample_source, sample_result):
...
class TestScrapingSourceDetail:
    def test_retrieve_source_includes_recent_results(self, api_client, sample_source, sample_result):
    ...
    def test_retrieve_source_recent_results_capped_at_10(self, api_client, sample_source):
...
class TestScrapedResultHistory:
    ...
    def test_filter_results_by_source(self, api_client, db):
        ...
        source_a = ScrapingSource.objects.create(
            ...
            rules={'t': {'selector': 'h1'}}, frequency_minutes=60,
        )
    ...
    def test_filter_results_by_missing_field(self, api_client, sample_source):
        ...
        ScrapedResult.objects.create(source=sample_source, data={'title': 'A', 'price': None})
        ScrapedResult.objects.create(source=sample_source, data={'title': 'B', 'price': 9.99})
