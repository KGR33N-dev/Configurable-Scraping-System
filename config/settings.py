...
SECRET_KEY = os.environ.get(
    "SECRET_KEY", "django-insecure-*mdj@2u6^usa-6e=n=shimy%pkhta^#%4kbu2omkdqfiz-achg"
)
...
SPECTACULAR_SETTINGS = {
    ...
    "DESCRIPTION": "System for managing sources and scraping results "
    "in the background.",
    "VERSION": "1.0.0",
...
CELERY_TASK_REJECT_ON_WORKER_LOST = (
    True  # Re-queue if worker is killed (OOM protection)
)
CELERY_WORKER_PREFETCH_MULTIPLIER = 1  # One task per worker — optimal for long IO tasks
CELERY_BROKER_CONNECTION_RETRY_ON_STARTUP = (
    True  # Silences Celery 5.x deprecation warning
)

CELERY_TASK_SOFT_TIME_LIMIT = (
    60 * 10
)  # 10 min — task gets SoftTimeLimitExceeded, can clean up
